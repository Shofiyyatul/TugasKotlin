 ...
 */
fun myProfile() {
    val firstName: String = "Shofiyyatul"
    println(firstName)

    val lastName: String = "Badriyyah"
    println(lastName)
 ...
 */
fun myGroup(): String {
    val memberGroup = arrayOf("Shofi", "Dwianna", "Nasya","Mallvino", "Yuda","Safrizal")
    val myName = memberGroup[0]
    return myName
}
...
fun main() {
     ...
     *
     */
    groupDetail(1, listOf("Shofi", "Dwianna", "Nasya","Mallvino", "Yuda","Safrizal"), "Morning")
